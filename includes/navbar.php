...
$sql = "SELECT logo FROM image LIMIT 1"; // Assuming there's only one row in the image table
...
<nav class="navbar navbar-expand-lg navbar-light bg-white ftco_navbar single-nav" id="ftco-navbar">
    <div class="container">
        <a href="index.php" style="display: inline-block; border-radius: 50%;">
            <img src="<?php echo $logoPath; ?>" alt="" style="max-height: 70px; max-width: 70px; border-radius: 50%;">
        </a>
