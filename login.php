...
<div class="container mt-5">
    ...
    <form class="p-5 border rounded shadow-sm">

        <!-- Email input -->
        <div class="mb-4">
            <label for="form2Example1" class="form-label">Email address</label>
            <input type="email" id="form2Example1" class="form-control col-sm-12" />
        </div>

        <!-- Password input -->
        <div class="mb-4">
            <label for="form2Example2" class="form-label">Password</label>
            <input type="password" id="form2Example2" class="form-control col-sm-12" />
        </div>
        ...
        <!-- Sign in button -->
        <button type="button" class="btn btn-block mb-4 custom-btn">Sign in</button>
